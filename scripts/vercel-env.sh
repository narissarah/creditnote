...
# Additional Postgres variables for Vercel compatibility
...
echo "You can verify them at: https://vercel.com/your-team/creditnote/settings/environment-variables"